...
/**
 * Class PMPro_Rest_Server
 *
 * Example rest server that allows for CRUD operations on the wp_options table
 */
class PMPro_Rest_Server extends WP_Rest_Controller {

	public $namespace = 'pmpro/';
	public $version = 'v1';
	...
	public function get_options_permission() {
		...
		if ( ! current_user_can( 'install_themes' ) ) {
			return new WP_Error( 'rest_forbidden', esc_html__( 'You do not have permissions to manage options.', 'pmpro-react-demo' ), array( 'status' => 401 ) );
		}
